...
(setf exp-loss
      (create-generic-process
       ...
       :entity-roles (list (make-entity-role
		       :name "G"
		       :types (list grazer)))))
...
(setf pp-lib 
      (make-library 
       ...
       :constraints (list (make-constraint
                            :name 'growth-mutex
                            :type 'exactly-one
                            :items (list (create-conmod :gp exp-growth)
                                         (create-conmod :gp log-growth)))
			  (make-constraint 
			   :name 'grazing-req
			   :type 'exactly-one
			   :items (list (create-conmod :gp grazing)))
			  (make-constraint
			   :name 'death-req
			   :type 'exactly-one
			   :items (list (create-conmod :gp exp-loss)))
			  (make-constraint
			   :name 'predation-req
			   :type 'exactly-one
			   :items (list (create-conmod :gp h1-pred)
					(create-conmod :gp h2-pred)
					(create-conmod :gp h3-pred)
					(create-conmod :gp gen-gause)
					(create-conmod :gp monod)
					(create-conmod :gp ivlev)
					(create-conmod :gp ratio-dep-2)
					(create-conmod :gp ratio-dep-3)
					(create-conmod :gp watts)
					(create-conmod :gp hv-1)
					(create-conmod :gp hv-2)
					(create-conmod :gp deangelis)
					(create-conmod :gp crowley)
					))
			)))
