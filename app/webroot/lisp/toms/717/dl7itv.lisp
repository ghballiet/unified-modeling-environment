...
(|COMMON-LISP|::|DEFUN| |FORTRAN-TO-LISP|::|DL7ITV|
   ...
   (|COMMON-LISP|::|PROG|
    ...
    (|COMMON-LISP|::|DECLARE|
     ...
     (|COMMON-LISP|::|TYPE| (|F2CL-LIB|::|INTEGER4|) |FORTRAN-TO-LISP|::|NP1|
      ...
      |FORTRAN-TO-LISP|::|IJ| |FORTRAN-TO-LISP|::|II| |FORTRAN-TO-LISP|::|I|))
    (|F2CL-LIB|::|FDO|
     (|FORTRAN-TO-LISP|::|I| 1.
    ...
    (|F2CL-LIB|::|FDO|
     ...
     (|COMMON-LISP|::|TAGBODY|
      ...
      (|COMMON-LISP|::|IF|
       (|COMMON-LISP|::|=| |FORTRAN-TO-LISP|::|XI| |FORTRAN-TO-LISP|::|ZERO|)
