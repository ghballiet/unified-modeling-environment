...
;;;
;; (load "sc-ipm.lisp")
(asdf:load-system :scipm)
;;; RAB  - changed path from relative to absolute
(load "~/isle/scipm/test_libs/amo1.lisp") ;library
...
;(format t "~S~%" (exhaustive sol-g 'dnf)) '("") (list p1 p2 n1) :nmodels 5 :restarts-full 2)