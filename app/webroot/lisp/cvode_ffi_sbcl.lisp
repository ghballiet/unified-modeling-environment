...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define-alien-routine get_sysvar_n int)

(define-alien-routine get_sysvar_val double
  (i int))

(define-alien-routine get_sysvar_dotval double
  (i int))

(define-alien-routine set_sysvar_val void
  (i int) 
  (x double))

(define-alien-routine set_sysvar_dotval void
  (i int) 
  (x double))

(define-alien-routine get_sensitivity double
  (pidx int)   ; the parameter index
  (vidx int))  ; the variable index

(define-alien-routine get_param_n int)

(define-alien-routine get_param_val double
  (i int))

(define-alien-routine set_param_val void
  (i int) 
  (x double))
...
;;; parameters
;;;
(define-alien-routine init_dims void
  (nsys_var int) 
  (nparam int)
...
;;;
(define-alien-routine mem_alloc int)
...
;;; will occur.
;;;
(define-alien-routine mem_free void)
...
;;;
(define-alien-routine fill_in int
  (start_time double)
...
;;;
(define-alien-routine init_cvode void
  (init_vals (* double-float))
  (start_time double))
...
;;;
(define-alien-routine sim_model_cvode int
  (sample_time double))
